package com.memsql.talend.components.service;
...
import com.memsql.talend.components.output.Column;
import com.memsql.talend.components.output.Table;
...
@Service
public class MemsqlComponentService {

    private static final transient Logger LOG = LoggerFactory.getLogger(MemsqlComponentService.class);
    ...
    public static boolean checkTableExistence(final String tableName, final MemsqlComponentService.DataSource dataSource)
            throws SQLException {
    ...
    public SuggestionValues getTableFromDatabase(@Option final MemSQLDatastore datastore) {
    ...
    public HealthCheckStatus validateConnection(@Option final MemSQLDatastore datastore)
    {
    ...
    public DataSource createDataSource(final MemSQLDatastore connection)
    {

        return new DataSource(i18n, connection, false, false);
    }

    public DataSource createDataSource(final MemSQLDatastore connection, final boolean rewriteBatchedStatements) {
        return new DataSource(i18n, connection, false, rewriteBatchedStatements);
    }

    public DataSource createDataSource(final MemSQLDatastore connection, boolean isAutoCommit,
    ...
    public static class DataSource implements AutoCloseable
    {
        ...
        private final MemSQLDatastore datastore;
        private final boolean isAutoCommit;
        private final boolean rewriteBatchedStatements;
        public DataSource(final I18nMessage i18nMessage, final MemSQLDatastore datastore,
