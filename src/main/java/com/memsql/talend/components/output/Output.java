package com.memsql.talend.components.output;
...
import com.memsql.talend.components.output.statement.QueryManager;
import com.memsql.talend.components.output.statement.QueryManagerFactory;
import com.memsql.talend.components.output.statement.operations.QueryManagerImpl;
...
@Icon(value = Icon.IconType.CUSTOM, custom = "MemSQL") // you can use a custom one using @Icon(value=CUSTOM, custom="filename") and adding icons/filename.svg in resources
...
public class Output implements Serializable {
    ...
    private transient MemsqlComponentService.DataSource datasource;
    ...
    public Output(@Option("configuration") final OutputConfiguration configuration,
                  final MemsqlComponentService service,
