package com.memsql.talend.components.datastore;
...
@Documentation("Connection to a MemSQL Database")
public class MemSQLDatastore implements Serializable {
    ...
    public MemSQLDatastore setJdbcUrl(String jdbcUrl) {
    ...
    public MemSQLDatastore setUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public MemSQLDatastore setPassword(String password) {
